                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12 col-md-9 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="bio_posisi_lamar" placeholder="Posisi yang dilamar" autocomplete="off" value="{{ $records->bio_posisi_lamar }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group row">
                                        <div class="col-lg-12 col-md-9 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="bio_nama" autocomplete="off" placeholder="nama" value="{{ $records->bio_nama }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group row">
                                        <div class="col-lg-12 col-md-9 col-sm-12">
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="bio_ktp" autocomplete="off" placeholder="No. KTP" value="{{ $records->bio_ktp }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="bio_tempat_lahir" autocomplete="off" placeholder="Tempat" value="{{ $records->bio_tempat_lahir }}"/>
                                                    </div>
                                                </div>
                                            <div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="col-lg-12">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control bio_tgl_lahir" name="bio_tgl_lahir" autocomplete="off" placeholder="Tanggal Lahir" value="{{ date('m/d/Y', strtotime($records->bio_tgl_lahir)) }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="bio_jk">
                                        ...
                                        <option {{ ($records->bio_jk == "L" ? "selected" : "") }} value="L">Laki-laki</option>
                                        <option {{ ($records->bio_jk == "P" ? "selected" : "") }} value="P">Perempuan</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form-group row">
                                        <div class="col-lg-12 col-md-9 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="bio_agama" autocomplete="off" placeholder="Agama" value=" {{ $records->bio_agama }} "/>
                                            </div>
                                        </div>
                                    </div>
                                </td>

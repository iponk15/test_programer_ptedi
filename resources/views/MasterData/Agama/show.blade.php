...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="agamaFormTambah" method="POST">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="agama_nama" placeholder="Masukan nama ..." autocomplete="off"/>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <textarea name="agama_deskripsi" class="form-control" rows="3" placeholder="Masukan deskripsi ..."></textarea>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('agamaFormTambah');

...
@section('content')
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <!--begin: Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom" id="ktTableAgama"></div>
            <!--end: Datatable-->
        </div>
    </div>
    <!--begin::Modal-->
    ...
    <script>
        $(document).ready(function(){
            ...
            var column = [
                ...
                { field : 'agama_nama', title : 'Nama' },
                { field : 'agama_deskripsi', title : 'Deskripsi'},
                ...
                { field : 'agama_created_date', title : 'Created At', width : 170, textAlign : 'center' },

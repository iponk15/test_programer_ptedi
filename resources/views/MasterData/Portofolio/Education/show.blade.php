...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="pendidikanFormTambah" method="POST">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="pendidikan_nama" placeholder="Masukan sekolah / universitas ..." autocomplete="off"/>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="pendidikan_catatan" placeholder="Masukan jenjang ..." autocomplete="off" />
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-2 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="number" class="form-control" name="pendidikan_order" placeholder="Masukan urutan ..." autocomplete="off" />
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('pendidikanFormTambah');

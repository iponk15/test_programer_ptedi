...
@section('content')
    <div class="card card-custom">
        ...
        <form class="form" id="negaraFormEdit" method="POST" data-cofirm="1">
            {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="negara_nama" placeholder="Masukan nama ..." autocomplete="off"/ value="{{ $records->negara_nama }}">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-9 col-sm-12">
                        <div class="input-group">
                            <input type="text" class="form-control" name="negara_deskripsi" placeholder="Masukan deskripsi ..." autocomplete="off" value="{{ $records->negara_deskripsi }}"/>
                        </div>
                        <span class="form-text text-muted"></span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var form   = document.getElementById('negaraFormEdit');
            var urll   = "{{ route($route . '.update', ['id' => $id]) }}";
            var fields = {
                negara_nama      : { validators : { notEmpty : { message : 'Nama tidak boleh kosong' } } },
                negara_deskripsi : { validators : { notEmpty : { message : 'De tidak boleh kosong' } } },
            };

            var params = ['_token','negara_nama','negara_deskripsi'];

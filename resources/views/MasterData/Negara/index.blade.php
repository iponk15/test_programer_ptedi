...
@section('content')
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <!--begin: Datatable-->
            <div class="datatable datatable-bordered datatable-head-custom" id="ktTableNegara"></div>
            <!--end: Datatable-->
        </div>
    </div>
    <!--begin::Modal-->
    ...
    <script>
        $(document).ready(function(){
            ...
            var column = [
                ...
                { field : 'negara_nama', title : 'Nama' },
                { field : 'negara_deskripsi', title : 'Deskripsi'},
                ...
                { field : 'negara_created_date', title : 'Created At', width : 170, textAlign : 'center' },
